...
<img src="assets/signal-dashboard.svg" alt="Live GitHub signal for the last 12 months: contributions, commits, pull requests, public repos and day streak, weekly contribution bars with the peak week and weekly average marked, and languages by bytes of code" width="100%" />

<sub>Live from the GitHub API — regenerated by GitHub Actions on every push and roughly every 3 hours. Not a static number.</sub>

<br>

<img src="assets/pacman-contributions.svg" alt="Pac-man eating Kartikeya Yadav's real GitHub contribution graph for the last 12 months while four ghosts give chase; the peak day is the power pellet that turns them blue" width="100%" />

<sub>The real 12-month contribution grid — pac-man eats actual commit days, and the peak day is the power pellet.</sub>
